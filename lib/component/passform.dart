...
class PassForm extends StatefulWidget {
  ...
  @override
  State<PassForm> createState() => _AddFormState();
}

class _AddFormState extends State<PassForm> {
              ...
              FormBuilder(
                ...
                child: Column(
                  children: <Widget>[
                        ...
                        FormBuilderValidators.maxLength( 10, errorText: 'Ce champ ne peut avoir plus de 10 caractères.'),
                          ...
                          if (val != null && int.tryParse(val) != null) {
                            if (int.parse(val) % 97 != 1) {
                              return "Le NINA inséré est incorrect";
                            }
                          }
                          return null;
                        }
                    ...
                    //           )
                    //       ),
                    //       items: listderoulante,
                    //       onChanged: (String? value) {
                    //         field.didChange(value);
                    //       },
                    //       // itemAsString: (Location loc) => '${loc.wilaya.toString()} - ${loc.moughataa.toString()} - ${loc.commune.toString()} - ${loc.localite.toString()}',
                    ...
                    //           labelStyle: C.headLineStyle3,
                    //           focusedBorder: OutlineInputBorder(
                    //             borderSide: BorderSide(width: 1.0, color: C.textColor),
                    //             borderRadius: BorderRadius.circular(20),
                    //           ),
                    //           enabledBorder: OutlineInputBorder(
                    //             borderSide: BorderSide(width: 1.0, color: Colors.transparent),
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        //         inscription =
                        //             Generer un pass.fromJson(inscriptionData);
                        //       }
